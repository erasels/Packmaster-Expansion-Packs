package thePackmaster.patches.turmoilpack;
...
import thePackmaster.cards.turmoilpack.ForsakenDreams;
...
public class FineTuneLineWidthPatch {
    ...
    private static boolean matches(AbstractCard card, String word) {
        return (card.cardID.equals(ForsakenDreams.ID) && word.equals("discarded"));
    }
